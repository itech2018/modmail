...
class Utility(commands.Cog):
    ...
    async def about(self, ctx):
        ...
        embed.set_author(
            ...
            url="https://discord.gg/jWaNs2a",
        )
        embed.set_thumbnail(url=self.bot.user.avatar_url)

        desc = "This is an Hamster Works Discord Bot that allows"
        ...
        embed.add_field(name="Authors", value="Hamster Works Development Team")
        ...
        embed.add_field(
            ...
            value="Join our discord server and start a ticket [Discord server](https://discord.gg/jWaNs2a)!",
            inline=False,
        )
    ...
    async def sponsors(self, ctx):
        ...
        resp = await self.bot.session.get(
            "https://raw.githubusercontent.com/itech2018/modmail/master/SPONSORS.json"
        )
